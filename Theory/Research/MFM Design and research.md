...
- everything must be open source and available to everyone , so anyone can see and improve everything we worked on
- the total cost should be no more than €150,00
